package cn.orgtec.hix.common.data.datascope;
...
import cn.orgtec.hix.common.core.exception.CheckedException;
import cn.orgtec.hix.common.data.enums.DataScopeTypeEnum;
...
public class DataScopeInterceptor extends AbstractSqlParserHandler implements Interceptor {
	...
	public Object intercept(Invocation invocation) {
		...
		if (CollUtil.isEmpty(deptIds)) {
			HixUser user = SecurityUtils.getUser();
			if (user == null) {
